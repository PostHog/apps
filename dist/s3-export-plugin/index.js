...
function convertEventBatchToBuffer(events) {
...
const sendBatchToS3 = async (events, meta) => {
    const { global, config } = meta;
...
export { convertEventBatchToBuffer, exportEvents, sendBatchToS3, setupPlugin };
