async function setupPlugin({ config, global }) {
    ...
    if (!statusOk(authResponse)) {
        throw new Error('Unable to connect to Mailboxlayer. Please make sure your API key is correct and that you are under your usage limit.');
    }
}
...
var mailboxlayerPlugin = {
    setupPlugin,
    processEventBatch
};

export { mailboxlayerPlugin as default };
