...
function transformEventToRow(fullEvent) {
    ...
    return {
        ...
        elements: JSON.stringify(elements !== null && elements !== void 0 ? elements : []),
        people_set: JSON.stringify($set !== null && $set !== void 0 ? $set : {}),
        people_set_once: JSON.stringify($set_once !== null && $set_once !== void 0 ? $set_once : {}),
    };
}
...
async function runEveryMinute({ jobs, global, storage, config, cache }) {
    ...
    if (!data) {
        ...
        data.unshift(`event|distinct_id|team_id|ip|site_url|timestamp|uuid|properties|elements|people_set|people_set_once`);
    }
...
export { posthogDatabricksPlugin as default };
