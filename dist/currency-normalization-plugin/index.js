...
async function processEvent(event, meta) {
    const { openExchangeRatesApiKey, normalizedCurrency, amountProperty, currencyProperty, normalizedAmountProperty, normalizedCurrencyProperty, } = meta.config;
    if (openExchangeRatesApiKey &&
        normalizedCurrency &&
        (event === null || event === void 0 ? void 0 : event.properties) &&
